...
#good omens
@neil_gaiman = Author.create(name: "Neil Gaiman", birthyear: 1960)
@terry_pratchett = Author.create(name: "Terry Pratchett", birthyear: 1948)
...
#heads you lose
@lisa_lutz = Author.create(name: "Lisa Lutz", birthyear: 1970)
@david_hayward = Author.create(name: "David Hayward", birthyear: 1880)
...
#between the lines
@jodi_picoult = Author.create(name: "Jodi Picoult", birthyear: 1966)
@samantha_van_leer = Author.create(name: "Samantha van Leer", birthyear: 1880)
...
@mary_higgins_clark = Author.create(name: "Mary Higgins Clark", birthyear: 1927)
@alafair_burke = Author.create(name: "Alafair Burke", birthyear: 1969)
...
#why we broke up
@daniel_handler = Author.create(name: "Daniel Handler", birthyear: 1970)
@maira_kalman = Author.create(name: "Maira Kalman", birthyear: 1949)
...
#the talisman
@stephen_king = Author.create(name: "Stephen King", birthyear: 1947)
@peter_straub = Author.create(name: "Peter Straub", birthyear: 1943)
...
#s
@j_j_abrams = Author.create(name: "J.J. Abrams", birthyear: 1966)
@doug_dorst = Author.create(name: "Doug Dorst", birthyear: 1880)
...
@rachel_cohn = Author.create(name: "Rachel Cohn", birthyear: 1968)
@david_levithan = Author.create(name: "David Levithan", birthyear: 1972)
...
#relic
@douglas_preston = Author.create(name: "Douglas Preston", birthyear: 1956)
@lincoln_child = Author.create(name: "Lincoln Child", birthyear: 1957)
